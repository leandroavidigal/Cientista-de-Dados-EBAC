...
def main():
    ...
    # SIDEBAR
    image = Image.open(r'C:\Users\yanks\EBAC - JUPYTER\CIENTISTA DE DADOS\M19 - Streamlit_II\img\Bank-Branding.jpg')
    ...
    file_path = r"C:\Users\yanks\EBAC - JUPYTER\CIENTISTA DE DADOS\M19 - Streamlit_II\data\input\bank-additional-full.csv"
    bank_raw = load_data(file_data=file_path, sep=';')
    bank = bank_raw.copy()
